  ...
  return (
    <Fragment>
      <h1 className="large text-primary">
			...
			<p className="lead">
				<i className="fas fa-user-tie"></i> Add any developer/programming positions
        ...
        addExperience(formData, history);
				...
				<div className="form-group">
					<input type="text" name="title" placeholder="* Job Title" value={title} onChange={e => onChange(e)} required />
				</div>
				<div className="form-group">
					<input type="text" name="company" placeholder="* Company" value={company} onChange={e => onChange(e)} required />
				</div>
				<div className="form-group">
          ...
          toggleDisabled(!toDateDisabled)
            ...
            value={description} onChange={e => onChange(e)}
				...
				<Link className="btn btn-light my-1" to="/dashboard"
					><i className="fas fa-chevron-left"></i> Go Back</Link>
			</form>
    </Fragment>
  )
}
