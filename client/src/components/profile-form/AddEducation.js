  ...
  return (
    <Fragment>
      <h1 className="large text-primary">
			...
			<p className="lead">
				<i className="fas fa-user-graduate"></i> Add any school, bootcamp, etc. that
				you have attended
			</p>
            ...
            value={school} onChange={e => onChange(e)}
				...
				<div className="form-group">
					<input
						type="text"
						name="degree"
						placeholder="* Degree or Certficate"
            required
            value={degree} onChange={e => onChange(e)}
					/>
				</div>
				<div className="form-group">
          <input type="text" name="fieldofstudy" placeholder="Field of Study" required 
